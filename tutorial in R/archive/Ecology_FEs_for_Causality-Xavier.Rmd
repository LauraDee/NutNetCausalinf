...
<a name="endogeneityback"></a>Researchers sometimes turn to random effects models to attempt to deal with confounding variables or *unobserved heterogeneity*. While random effects models have a number of useful properties (reviewed in @bell2019fixed), they **do not solve [endogeneity problems](#endogeneity)** on their own (see [**Appendix**](#appendix-more-details-on-random-effects-and-their-assumptions) and [@wooldridge2015introductory; @wooldridge2010econometric;@larsen2019causal]). Any variable that is omitted from a random effects model is implicitly assumed to either have no effect on productivity or to be uncorrelated with explanatory variables. So, random effects on their own don't really buy us anything more than conditioning on observables in terms of establishing causality. 
...
: to do See [@wooldridge2010econometric] and [@Cameron2015].
...
: to do [@wooldridge2015introductory] reviewed in [@larsen2019causal] and [@kendall2015statistical] for ecologists.
[placeholder](https://www.youtube.com/watch?v=_sRlvKws7F8)

<a name="identification">Identification</a>
: to do reviewed in [@larsen2019causal] for ecologists 
...
**others definitions needed?**

<a name="rivalexplanations">[rival explanations](#rivalexplanationsback)</a>

: to do

<a name="dag">[Direct Acyclic Diagram](#dagback)</a>

: to do

<a name="conditionning">[Conditionning on Observables](#selectionobservback)</a>
...
# Appendix: More details on random effects and their assumptions

See [@wooldridge2010econometric] Chapter 10 and and Appendix to Ch 14 in [@wooldridge2015introductory].

PLACEHOLDER FOR more info on this from Wooldridge:
<center>
<br />
<img src="https://i.imgur.com/eL7iQ02.png" width="100%" />
<br />
</center>   
