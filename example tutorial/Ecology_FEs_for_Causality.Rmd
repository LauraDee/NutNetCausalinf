...
# Note that Laura has more references and definitions to add in before the final product
...
The assumptions for each design are laid out in simple form in Figure 3 in the main text (and see below), and at length in the Supplemental Materials. 
