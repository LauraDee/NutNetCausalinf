...
library(here)
library(plyr)
expdes <- read.csv(here::here("data", "BioCONExpDes.csv"))
tbiomass <- read.delim(here::here("data","AbvGrndBiomass_2017.txt"))
...
#save data 
write.csv(tbiomass, here::here("data","biocon_for_ld.csv"))
write.csv(comb, here::here("data", "biocon_plantedbiomass_output.csv"))
